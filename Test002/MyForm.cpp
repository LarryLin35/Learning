...
System::Void UI::MyForm::MainForm_Load(System::Object^  sender, System::EventArgs^  e)
{
	...
	//this->userControlOfCameraSetting_001->ButtonShotClickEvent += gcnew CameraSetting::ButtonClickEventHandler(OpenCVObject, &ClassOpenCV::TT);//非"受控制"不行
}
...
System::Void UI::MyForm::button_ApplyHoughCircle_Click(System::Object^  sender, System::EventArgs^  e)
{
	if (OpenCVObject.PresentMat.empty() == 0)
	{
		...
		for (size_t i = 0; i < circles.size(); i++)
		{
			...
			circle(OpenCVObject.PresentMat, center, radius, Scalar(0, 0, 255), 1, 8, 0);//圓
